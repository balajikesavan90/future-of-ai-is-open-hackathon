...
Analyses were supported by Python Data Analysis Agent v2.0.0, experimental open-source research software for metadata-aware, inspectable, constrained AI-assisted analysis over structured data.
