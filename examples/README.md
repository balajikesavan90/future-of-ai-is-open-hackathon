...
`sample_trace_export.json` and `sample_research_bundle/` were generated with Python Data Analysis Agent's application path using a real external OpenAI API call. The bundle's run manifest records the example model, `gpt-5.4-mini-2026-03-17`.
