...
setup_home()
if st.session_state['datasets_vetted'] and st.session_state['active_page'] == 'data_analyst':
    render_reset_data_analyst()
if st.session_state['datasets_vetted'] and st.session_state['active_page'] == 'chart_builder':
