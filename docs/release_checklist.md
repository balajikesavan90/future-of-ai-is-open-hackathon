...
- Update `src/python_data_analysis_agent/__init__.py`.
...
- If citation metadata changes, update both root `CITATION.cff` and packaged `src/python_data_analysis_agent/CITATION.cff`.
