...
def render_data_analyst():
    ...
    st.divider()
    st.caption(':green[Arctic Analytics AI now has access to the metadata of the files you uploaded. Arctic Analytics will use that to generate code snippets.]')
    st.caption(':blue[The code generated by the AI will be executed in a sandbox environment. The results will be displayed here. The AI does not have access to the results.]')
    ...
    st.session_state['model'] = st.sidebar.selectbox('Select the model:', ['meta/meta-llama-3.1-405b-instruct', 'gpt-4.1-mini-2025-04-14'], index=0)
