...
def render_tool_calling_analysis_prompt_guide():
    ...
    with st.sidebar.expander(':blue[Prompt Guide]'):
        st.write("""Python Data Analysis Agent is designed for metadata-aware analysis over structured data. Follow this guide to make the analysis easier to inspect:
1. Make sure you provide a good dataset description and a short description of each column in your dataset. This will help Python Data Analysis Agent understand your data better.
...
""")
        st.info('Review the tool calls made by Python Data Analysis Agent.')
